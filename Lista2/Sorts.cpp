...
void quickSort(vector<int>& A, int p,int r)
{
    ...
    void quickinSort(vector<int>& list, int start, int end)
    {
        if (start < end)
        {
            ...
            {
                int part = rand_part(list, start, end);
                quickinSort(list, start, part - 1);
                quickinSort(list, part + 1, end);
            }
        }
    }
